...
*   **[S - Single Responsibility Principle (SRP)](./1-single-responsibility-principle.md)**
    *   *A class should have one, and only one, reason to change.*
*   **[O - Open-Closed Principle (OCP)](./2-open-closed-principle.md)**
    *   *Software entities should be open for extension, but closed for modification.*
*   **[L - Liskov Substitution Principle (LSP)](./3-liskov-substitution-principle.md)**
    *   *Subtypes must be substitutable for their base types without altering the correctness of the program.*
*   **[I - Interface Segregation Principle (ISP)](./4-interface-segregation-principle.md)**
    *   *Clients should not be forced to depend upon interfaces that they do not use.*
*   **[D - Dependency Inversion Principle (DIP)](./5-dependency-inversion-principle.md)**
